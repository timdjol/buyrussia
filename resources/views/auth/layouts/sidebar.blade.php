<div class="sidebar">
    ...
    <ul>
        ...
        <li @routeactive('categor*')><a href="{{ route('categories.index')}}"><i class="fa-solid fa-list"></i>
                Categories</a></li>
{{--        <li @routeactive('tag*')><a href="{{ route('tags.index')}}"><i class="fa-solid fa-tag"></i> Tags</a></li>--}}
        <li @routeactive('post*')><a href="{{ route('posts.index')}}"><i class="fa-solid fa-signs-post"></i>
            Posts</a></li>
        <li @routeactive('item*')><a href="{{ route('items.index')}}"><i class="fa-solid fa-signs-post"></i>
            Organizations</a></li>
